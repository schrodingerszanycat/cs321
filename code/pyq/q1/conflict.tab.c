...
static const char *const yytname[] =
{
  ...
  "ID", "ASSIGN", "SEMI", "$accept", "program", "stmt", YY_NULLPTR
};
...
#line 19 "conflict.y"
                   { printf("Parsing successful (Conflict version).\n"); }
#line 1071 "conflict.tab.c"
    break;


#line 1075 "conflict.tab.c"
