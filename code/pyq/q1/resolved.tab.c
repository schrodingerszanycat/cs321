...
static const char *const yytname[] =
{
  ...
  "ID", "ASSIGN", "SEMI", "LOWER_THAN_ELSE", "$accept", "program", "stmt", YY_NULLPTR
};
...
{
       1,    11,     5,     2,    13,     6,     7,     8,     9,    10,
      12
};

static const yytype_int8 yycheck[] =
{
       3,     9,     6,     6,    12,     7,     0,     8,     4,     6,
       5
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* program: stmt SEMI  */
#line 25 "resolved.y"
                   { printf("Parsing successful (Resolved version).\n"); }
#line 1071 "resolved.tab.c"
    break;


#line 1075 "resolved.tab.c"
