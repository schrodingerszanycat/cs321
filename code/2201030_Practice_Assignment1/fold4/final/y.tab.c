...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ENDMARKER = 8,                  /* ENDMARKER  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "IDENTIFIER", "PLUS",
  "TIMES", "LPAREN", "RPAREN", "ENDMARKER", "END_OF_INPUT", "$accept",
  "program", YY_NULLPTR
};
