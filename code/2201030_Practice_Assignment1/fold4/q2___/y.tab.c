...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LOWER_A = 3,                    /* LOWER_A  */
  YYSYMBOL_LOWER_B = 4,                    /* LOWER_B  */
  YYSYMBOL_END = 5,                        /* END  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "LOWER_A", "LOWER_B",
  "END", "END_OF_INPUT", "$accept", "program", YY_NULLPTR
};
