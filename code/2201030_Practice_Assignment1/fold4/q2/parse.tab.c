...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOKEN_A = 3,                    /* TOKEN_A  */
  YYSYMBOL_TOKEN_B = 4,                    /* TOKEN_B  */
  YYSYMBOL_END = 5,                        /* END  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "TOKEN_A", "TOKEN_B",
  "END", "$accept", "start", "S", "A", "B", YY_NULLPTR
};
...
yyreduce:
  ...
  case 2: /* start: S END  */
#line 58 "parse.y"
              { printf("Input buffer is accepted\n"); return 0; }
#line 1109 "parse.tab.c"
    break;

  case 3: /* start: error END  */
#line 59 "parse.y"
                  { printf("Input buffer is not accepted\n"); return 1; }
#line 1115 "parse.tab.c"
    break;

  case 4: /* S: A B  */
#line 62 "parse.y"
        { printf("Used production: S→AB\n"); }
#line 1121 "parse.tab.c"
    break;

  case 5: /* A: TOKEN_A A  */
#line 65 "parse.y"
              { printf("Used production: A→aA\n"); }
#line 1127 "parse.tab.c"
    break;

  case 6: /* A: %empty  */
#line 66 "parse.y"
                  { printf("Used production: A→ε\n"); }
#line 1133 "parse.tab.c"
    break;

  case 7: /* B: TOKEN_B  */
#line 69 "parse.y"
            { printf("Used production: B→b\n"); }
