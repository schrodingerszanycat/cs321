...
{
  "\"end of file\"", "error", "\"invalid token\"", "DECIMAL", "$accept",
  "input", YY_NULLPTR
};
...
#line 1071 "dec_to_bin.tab.c"
    break;


#line 1075 "dec_to_bin.tab.c"
